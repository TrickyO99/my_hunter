...
void	reduction3(int i, va_list ap, char *format)
{
	...
	if (format[i] == '%') {
		if (format[i + 1] != '%' && format[i + 1] != 'S' && format[i + 1] != 'b' && format[i + 1] != 'p' && format[i + 1] != 's' && format[i + 1] != 'c' && format[i + 1] != 'u' && format[i + 1] != 'x' && format[i + 1] != 'o' && format[i + 1] != 'd' && format[i + 1] != 'i' && format[i + 1] != 'X') {
			my_putchar(format[i]);
